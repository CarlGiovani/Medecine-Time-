...
public class EditReminderActivity extends AppCompatActivity {
    ...
    // Simulated existing reminder data
    private String existingReminderName = "Take Vitamin C";
    ...
    private String existingNote = "Take after breakfast";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_edit_reminder); // reuse layout

        HeaderManager.setupHeader(this);
        reminderNameInput = findViewById(R.id.medicineNameInput); // still medicineNameInput in layout
        ...
        if (reminder != null) {
            // populate fields with reminder.getName() and reminder.getType()
        }
    ...
    private void loadExistingData() {
        reminderNameInput.setText(existingReminderName);
    ...
    private void saveReminder() {
        ...
        // TODO: Save the updated reminder to database or pass back to previous activity
